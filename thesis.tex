...
\begin{acknowledgments}
  I would first like to thank my thesis advisor Scott Kuindersma. It has been a privilege to be his student and I appreciate his guidance, patience, and immense knowledge in helping me throughout the course of my study.

  I would also like to thank Myunghee Kim, who was integral to the work in this thesis. As the central point of contact in the multi-joint study, her coordination of the various components of development was instrumental.

  Lastly, I'd like to thank Professor Conor Walsh, his lab and the Wyss staff, in particular Nikos Karavas, Sangjun Lee, Jinsoo Kim, Chih-Kang Chang, Asa Eckert-Erdheim, Maria Athanassiu, Brice Mikala Iwangou, Nicolas Menard, and Sarah Sullivan.
\end{acknowledgments}
\begin{dedication}
  To my parents
\end{dedication}
